 ...
 *
 */
$drupal_hash_salt = 'nZj1qsLFhyQVqr1fgrQkxe1FP-VSB_Exm6Qwjx58lmc';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_delphi_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_delphi_dd.inc';
}
// </DDSETTINGS>
